...
public class BirthCertificateActivity extends AppCompatActivity {
    ...
    Button buttonChooseBirthCertificate;
    Button buttonUploadBirthCertificate;
    TextView text_BirthCertificate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_BirthCertificate = findViewById(R.id.text_BirthCertificate);
        buttonChooseBirthCertificate = findViewById(R.id.buttonChooseBirthCertificate);
        buttonUploadBirthCertificate = findViewById(R.id.buttonUploadBirthCertificate);

        storageReference = FirebaseStorage.getInstance().getReference();
        databaseReference = FirebaseDatabase.getInstance().getReference("MobileStudent");

        buttonUploadBirthCertificate.setEnabled(false);

        buttonChooseBirthCertificate.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void uploadPDFFirebase(Uri data) {
        ...
        reference.putFile(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                putPDF putPDF = new putPDF(text_BirthCertificate.getText().toString(), uri.toString());
                databaseReference.child(databaseReference.push().getKey()).setValue(putPDF);
                Toast.makeText(BirthCertificateActivity.this, "File Upload", Toast.LENGTH_LONG).show();
